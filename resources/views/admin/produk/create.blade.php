...
@section('subtitle', 'Tambahkan produk tahu baru ke katalog Anda')
      ...
      <form action="{{ route('admin.produk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="number" id="harga" name="harga" value="{{ old('harga') }}" step="1000" min="0"
        ...
        <div>
          ...
          <input type="text" id="satuan" name="satuan" value="{{ old('satuan', 'Pcs') }}"
        ...
        <div>
          ...
          <textarea id="deskripsi" name="deskripsi" rows="4"
            ...
            placeholder="Jelaskan keunggulan dan karakteristik produk...">{{ old('deskripsi') }}</textarea>
          @error('deskripsi')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="flex items-center">
          <input type="checkbox" id="aktif" name="aktif" value="1" {{ old('aktif') ? 'checked' : '' }}
