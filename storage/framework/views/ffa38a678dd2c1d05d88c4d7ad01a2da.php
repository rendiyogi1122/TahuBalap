...
<?php $__env->startSection('subtitle', 'Tambahkan kategori produk tahu baru'); ?>
...
unset($__errorArgs, $__bag); ?> rounded-lg focus:ring-2 focus:ring-[#FF5C00] focus:outline-none transition"
            placeholder="Jelaskan jenis dan karakteristik produk dalam kategori ini..."><?php echo e(old('deskripsi')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\kategori\create.blade.php ENDPATH**/ ?>