...
<?php $__env->startSection('title', 'Tambah Resep'); ?>
<?php $__env->startSection('subtitle', 'Tambahkan resep tahu baru'); ?>
...
<form action="<?php echo e(route('admin.resep.store')); ?>" method="POST" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?><p style="color:#ef4444; font-size:11px; margin:4px 0 0;"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
            <div>
              ...
              <select name="kategori" required
                ...
                <option value="Street Style" <?php echo e(old('kategori') == 'Street Style' ? 'selected' : ''); ?>>Street Style</option>
                <option value="Vegan Specials" <?php echo e(old('kategori') == 'Vegan Specials' ? 'selected' : ''); ?>>Vegan Specials</option>
                <option value="Quick & Spicy" <?php echo e(old('kategori') == 'Quick & Spicy' ? 'selected' : ''); ?>>Quick & Spicy</option>
              </select>
            </div>
            <div>
              ...
              <select name="level" required
                ...
                <option value="Easy" <?php echo e(old('level') == 'Easy' ? 'selected' : ''); ?>>Easy</option>
                <option value="Intermediate" <?php echo e(old('level') == 'Intermediate' ? 'selected' : ''); ?>>Intermediate</option>
                <option value="Expert" <?php echo e(old('level') == 'Expert' ? 'selected' : ''); ?>>Expert</option>
              </select>
            </div>
          </div>
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px;">
            <div>
              ...
              <input type="number" name="waktu" value="<?php echo e(old('waktu', 15)); ?>" min="1" required
                style="width:100%; border:1px solid #e5e7eb; border-radius:10px; padding:10px 14px; font-size:13px; font-family:inherit; box-sizing:border-box; outline:none;"
                onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'">
            </div>
            <div>
              ...
              <input type="number" name="harga" value="<?php echo e(old('harga', 0)); ?>" min="0"
                style="width:100%; border:1px solid #e5e7eb; border-radius:10px; padding:10px 14px; font-size:13px; font-family:inherit; box-sizing:border-box; outline:none;"
                onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'">
            </div>
            <div>
              ...
              <input type="text" name="emoji" value="<?php echo e(old('emoji', '🧀')); ?>"
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
            ...
            <div>
              ...
              <input type="color" name="badge_color" value="<?php echo e(old('badge_color', '#FF5C00')); ?>"
          ...
          <div>
            ...
            <textarea name="deskripsi" rows="3" required
              ...
              onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'"><?php echo e(old('deskripsi')); ?></textarea>
          </div>
          ...
          <div>
            ...
            <textarea name="tips" rows="2"
              ...
              onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'"><?php echo e(old('tips')); ?></textarea>
          </div>
    ...
    <div style="display:flex; flex-direction:column; gap:20px;">
      ...
      <div style="background:white; border-radius:16px; border:1px solid #f3f4f6; padding:24px;">
        ...
        <textarea name="bahan" rows="8" required
          ...
          onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'"><?php echo e(old('bahan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div style="background:white; border-radius:16px; border:1px solid #f3f4f6; padding:24px;">
        ...
        <textarea name="langkah" rows="8" required
          ...
          onfocus="this.style.borderColor='#FF5C00'" onblur="this.style.borderColor='#e5e7eb'"><?php echo e(old('langkah')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\resep\create.blade.php ENDPATH**/ ?>