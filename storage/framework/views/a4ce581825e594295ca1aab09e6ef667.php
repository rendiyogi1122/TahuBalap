      ...
      <div class="px-8 pb-8 -mt-6 relative">
        ...
        <div class="bg-white rounded-2xl shadow-lg shadow-orange-100/40 border border-orange-50 p-6 mb-6">
          ...
          <div class="bg-tertiary-fixed text-on-tertiary-fixed-variant rounded-xl px-4 py-3 text-sm font-bold mb-4 flex items-center gap-2">
            <span class="material-symbols-outlined text-sm">check_circle</span> <?php echo e(session('status')); ?>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                  class="w-full pl-11 pr-4 py-3 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error bg-error-container/20 <?php else: ?> border-outline-variant <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
              <p class="text-error text-xs mt-1 flex items-center gap-1">
                <span class="material-symbols-outlined text-xs">error</span> <?php echo e($message); ?>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="password" name="password" id="password" required
                  class="w-full pl-11 pr-12 py-3 border border-outline-variant rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-[#FF5C00] font-bold hover:underline">
                Lupa password?
              </a>
              <?php endif; ?>
            </div>
        ...
        <p class="text-center text-sm text-on-surface-variant">
          Belum punya akun?
          <a href="<?php echo e(route('register')); ?>" class="text-[#FF5C00] font-black hover:underline ml-1">Daftar Gratis</a>
        </p>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\auth\login.blade.php ENDPATH**/ ?>