  ...
  <aside class="fixed left-0 top-0 h-screen flex flex-col bg-white w-64 border-r border-slate-100 shadow-sm z-50">
    ...
    <nav class="flex-1 py-4 space-y-1 overflow-y-auto">
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
        <span class="material-symbols-outlined text-sm" style="<?php echo e(request()->routeIs('admin.dashboard') ? 'font-variation-settings: \"FILL\" 1' : ''); ?>">dashboard</span> Dashboard
      </a>
      <a href="<?php echo e(route('admin.produk.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.produk.*') ? 'active' : ''); ?>">
        <span class="material-symbols-outlined text-sm" style="<?php echo e(request()->routeIs('admin.produk.*') ? 'font-variation-settings: \"FILL\" 1' : ''); ?>">inventory_2</span> Produk
      </a>
      <a href="<?php echo e(route('admin.kategori.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.kategori.*') ? 'active' : ''); ?>">
        <span class="material-symbols-outlined text-sm" style="<?php echo e(request()->routeIs('admin.kategori.*') ? 'font-variation-settings: \"FILL\" 1' : ''); ?>">category</span> Kategori
      </a>
      <a href="<?php echo e(route('admin.pesanan.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.pesanan.*') ? 'active' : ''); ?>">
        <span class="material-symbols-outlined text-sm" style="<?php echo e(request()->routeIs('admin.pesanan.*') ? 'font-variation-settings: \"FILL\" 1' : ''); ?>">shopping_basket</span> Pesanan
      </a>
      <a href="<?php echo e(route('admin.user.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.user.*') ? 'active' : ''); ?>">
        <span class="material-symbols-outlined text-sm" style="<?php echo e(request()->routeIs('admin.user.*') ? 'font-variation-settings: \"FILL\" 1' : ''); ?>">group</span> Pengguna
      </a>
    ...
    <div class="p-4 border-t border-slate-100">
      <div class="flex items-center gap-3 px-2 mb-3">
        ...
        <div>
          <p class="text-sm font-bold text-on-surface"><?php echo e(auth()->user()->name); ?></p>
  ...
  <main class="flex-1 ml-64 min-h-screen">
    <div class="p-10">
      ...
      <header class="flex justify-between items-center mb-10">
        <div>
          <h1 class="text-headline-lg font-black text-on-surface tracking-tight"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
          <p class="text-body-md text-on-surface-variant"><?php echo $__env->yieldContent('subtitle', 'Selamat datang di panel admin TahuBalap'); ?></p>
        </div>
      ...
      <div class="mb-6 bg-tertiary-fixed text-on-tertiary-fixed-variant border border-tertiary-fixed-dim rounded-xl px-5 py-3 flex items-center justify-between font-bold text-sm">
        <span class="flex items-center gap-2"><span class="material-symbols-outlined text-sm">check_circle</span> <?php echo e(session('sukses')); ?></span>
      ...
      <div class="mb-6 bg-error-container text-on-error-container border border-error/20 rounded-xl px-5 py-3 flex items-center justify-between font-bold text-sm">
        <span class="flex items-center gap-2"><span class="material-symbols-outlined text-sm">error</span> <?php echo e(session('error')); ?></span>
        <button onclick="this.parentElement.remove()" class="material-symbols-outlined text-sm">close</button>
      </div>
      <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\admin.blade.php ENDPATH**/ ?>