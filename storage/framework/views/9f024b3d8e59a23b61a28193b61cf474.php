...
<?php $__env->startSection('title', $resep['nama']); ?>

<?php $__env->startSection('content'); ?>
<div style="max-width:900px; margin:0 auto; padding:32px 24px;">

  <a href="<?php echo e(route('resep.index')); ?>" style="display:inline-flex; align-items:center; gap:6px; color:#FF5C00; font-weight:700; font-size:13px; text-decoration:none; margin-bottom:24px;">
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:32px; align-items:start;">
                ...
                <?php if($resep->gambar): ?>
                  <img src="<?php echo e(Storage::url($resep->gambar)); ?>" style="width:100%; height:100%; object-fit:cover; border-radius:24px;">
                <?php else: ?>
                  <span style="font-size:140px;"><?php echo e($resep->emoji); ?></span>
                <?php endif; ?>
              <div style="position:absolute; top:16px; left:16px; background:<?php echo e($resep->badge_color); ?>; color:white; font-size:11px; font-weight:800; padding:6px 14px; border-radius:8px; letter-spacing:1px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px; margin-bottom:20px;">
        <div style="background:white; border:1px solid #f3f4f6; border-radius:12px; padding:14px; text-align:center;">
          ...
          <p style="font-size:14px; font-weight:800; color:#1f2937; margin:0;"><?php echo e($resep['waktu']); ?></p>
        </div>
        <div style="background:white; border:1px solid #f3f4f6; border-radius:12px; padding:14px; text-align:center;">
          ...
          <p style="font-size:14px; font-weight:800; color:#1f2937; margin:0;"><?php echo e($resep['level']); ?></p>
        </div>
        <div style="background:white; border:1px solid #f3f4f6; border-radius:12px; padding:14px; text-align:center;">
          ...
          <p style="font-size:13px; font-weight:800; color:#1f2937; margin:0;"><?php echo e($resep['kategori']); ?></p>
        </div>
      </div>
      ...
      <div style="background:white; border:1px solid #f3f4f6; border-radius:16px; padding:24px;">
        ...
        <ul style="margin:0; padding:0; list-style:none; display:flex; flex-direction:column; gap:10px;">
          <?php $__currentLoopData = $resep['bahan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div>
      ...
      <h1 style="font-size:28px; font-weight:900; color:#1f2937; margin:0 0 12px; line-height:1.2;"><?php echo e($resep['nama']); ?></h1>
      <p style="font-size:14px; color:#6b7280; margin:0 0 28px; line-height:1.7;"><?php echo e($resep['deskripsi']); ?></p>
      ...
      <div style="background:white; border:1px solid #f3f4f6; border-radius:16px; padding:24px; margin-bottom:20px;">
        ...
        <div style="display:flex; flex-direction:column; gap:16px;">
          <?php $__currentLoopData = $resep['langkah']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $langkah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div style="display:flex; gap:14px; align-items:flex-start;">
            ...
            <p style="font-size:13px; color:#374151; margin:0; line-height:1.6; padding-top:4px;"><?php echo e($langkah); ?></p>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
      ...
      <div style="background:linear-gradient(135deg, #FEB700, #FF8C00); border-radius:16px; padding:20px; margin-bottom:20px;">
        ...
        <p style="font-size:13px; color:#521800; margin:0; line-height:1.6; opacity:0.85;"><?php echo e($resep['tips']); ?></p>
      </div>
  ...
  <div style="margin-top:48px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:16px;">
      <?php $__currentLoopData = collect($reseps)->where('slug', '!=', $resep['slug'])->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route('resep.show', $r['slug'])); ?>"
        ...
        <span style="font-size:36px;"><?php echo e($r['emoji']); ?></span>
        <div>
          <p style="font-size:13px; font-weight:800; color:#1f2937; margin:0 0 3px;"><?php echo e($r['nama']); ?></p>
          <p style="font-size:11px; color:#9ca3af; margin:0; font-weight:600;"><?php echo e($r['waktu']); ?> · <?php echo e($r['level']); ?></p>
        </div>
      </a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\resep\show.blade.php ENDPATH**/ ?>