...
<?php $__env->startSection('subtitle', 'Selamat datang kembali, Admin!'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:20px; margin-bottom:24px;">
    ...
    <div
      ...
      <p style="font-size:26px; font-weight:900; color:#1f2937; margin:0;">
        Rp<?php echo e(number_format($stats['pendapatan_bulan'], 0, ',', '.')); ?></p>
    </div>
    ...
    <div
      ...
      <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:16px;">
        ...
        <!-- <span
              ...
              <?php echo e($stats['pesanan_hari_ini']); ?></span> -->
      </div>
      <p
        style="font-size:11px; font-weight:700; color:#9ca3af; text-transform:uppercase; letter-spacing:1px; margin:0 0 6px;">
        Total Pesanan Masuk</p>
      <p style="font-size:26px; font-weight:900; color:#1f2937; margin:0;"><?php echo e($stats['total_pesanan']); ?></p>
    </div>
    ...
    <div
      ...
      <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:16px;">
        ...
        <?php if($stats['stok_menipis'] > 0): ?>
          <span
            style="background:#fef2f2; color:#ef4444; font-size:11px; font-weight:800; padding:4px 10px; border-radius:20px;"><?php echo e($stats['stok_menipis']); ?>
      ...
      <p
        style="font-size:11px; font-weight:700; color:#9ca3af; text-transform:uppercase; letter-spacing:1px; margin:0 0 6px;">
        Total Produk</p>
      <p style="font-size:26px; font-weight:900; color:#1f2937; margin:0;"><?php echo e($stats['total_produk']); ?></p>
    </div>
  </div>
  ...
  <div style="display:grid; grid-template-columns:1fr 320px; gap:20px; margin-bottom:24px;">
    ...
    <div
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
        ...
        <select onchange="window.location.href = '<?php echo e(route('admin.dashboard')); ?>?periode=' + this.value"
          ...
          <option value="7" <?php echo e($periode_aktif === 7 ? 'selected' : ''); ?>>7 hari terakhir</option>
          <option value="30" <?php echo e($periode_aktif === 30 ? 'selected' : ''); ?>>30 hari terakhir</option>
        </select>
      </div>
      ...
      <div style="display:flex; align-items:flex-end; gap:10px; height:180px; padding-bottom:8px;">
        <?php $__currentLoopData = $tren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          <div
            ...
            <?php if($isToday && $data['pesanan'] > 0): ?>
              <div
                ...
                Today: <?php echo e($data['pesanan']); ?> pesanan
                <div
            ...
            <div style="flex:1; display:flex; flex-direction:column; justify-content:flex-end; width:100%;">
              <div
                style="width:100%; height:<?php echo e($persen); ?>%; background:<?php echo e($warna); ?>; border-radius:8px 8px 0 0; transition:all 0.3s; cursor:pointer;"
                onmouseover="this.style.background='#FF5C00'; this.style.opacity='0.9'"
                onmouseout="this.style.background='<?php echo e($warna); ?>'; this.style.opacity='1'"
                title="<?php echo e($data['tanggal']); ?>: <?php echo e($data['pesanan']); ?> pesanan">
              </div>
            </div>
            ...
            <div style="text-align:center;">
              <div
                style="font-size:11px; font-weight:800; color:<?php echo e($isToday ? '#FF5C00' : '#9ca3af'); ?>; text-transform:uppercase;">
                <?php echo e(strtoupper($data['label'])); ?>
        ...
        <?php if($bestSeller): ?>
          <div
            ...
            <div
              ...
              <?php if($bestSeller->gambar): ?>
                <img src="<?php echo e(Storage::url($bestSeller->gambar)); ?>" style="width:100%; height:100%; object-fit:cover;">
              <?php else: ?>
                <span style="font-size:24px;">🧀</span>
              <?php endif; ?>
            </div>
            <div>
              <p style="font-weight:800; font-size:14px; margin:0 0 2px;"><?php echo e($bestSeller->nama); ?></p>
  ...
  <div
    ...
    <div
      ...
      <div style="display:flex; gap:10px; align-items:center;">
        <div style="position:relative;">
          ...
          <input type="text" id="searchInput" placeholder="Cari pesanan..." value="<?php echo e(request('search')); ?>"
    ...
    <script>
      ...
      function submitDateFilter() {
        ...
        let url = '<?php echo e(route("admin.dashboard")); ?>?';
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $pesananTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pesanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <tr style="border-top:1px solid #f3f4f6; transition:background 0.15s;"
            ...
            <td style="padding:16px 28px; font-weight:800; font-size:13px; color:#1f2937;">#<?php echo e($pesanan->kode_pesanan); ?>
            ...
            <td style="padding:16px;">
              <div style="display:flex; align-items:center; gap:10px;">
                ...
                <span style="font-size:13px; font-weight:600; color:#1f2937;"><?php echo e($pesanan->user->name); ?></span>
              </div>
            </td>
            <td style="padding:16px; font-size:13px; color:#6b7280;"><?php echo e($pesanan->created_at->format('M d, H:i')); ?></td>
            <td style="padding:16px; font-size:13px; font-weight:800; color:#1f2937;">
              Rp<?php echo e(number_format($pesanan->total_harga, 0, ',', '.')); ?></td>
            <td style="padding:16px;">
              <span
                style="background:<?php echo e($statusStyle[0]); ?>; color:<?php echo e($statusStyle[1]); ?>; font-size:11px; font-weight:800; padding:5px 12px; border-radius:20px;">
                <?php echo e($statusStyle[2]); ?>
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:20px;">
    ...
    <div
      ...
      <div>
        <?php $__empty_1 = true; $__currentLoopData = $produkStokSedikit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div
            style="padding:12px 24px; border-bottom:1px solid #f9fafb; display:flex; justify-content:space-between; align-items:center;">
            <span style="font-size:13px; color:#1f2937; font-weight:600;"><?php echo e($p->nama); ?></span>
            <span
              style="background:#fef2f2; color:#ef4444; font-size:11px; font-weight:800; padding:3px 10px; border-radius:20px;"><?php echo e($p->stok); ?>

              <?php echo e($p->satuan); ?></span>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div
      ...
      <div style="display:flex; flex-direction:column; gap:16px;">
        <div
          ...
          <span style="font-size:18px; font-weight:900; color:#1f2937;"><?php echo e($stats['total_customer']); ?></span>
        </div>
        <div
          style="display:flex; justify-content:space-between; align-items:center; padding-bottom:16px; border-bottom:1px solid #f3f4f6;">
          <span style="font-size:13px; color:#6b7280; font-weight:600;">Pesanan Hari Ini</span>
          <span style="font-size:18px; font-weight:900; color:#FF5C00;"><?php echo e($stats['pesanan_hari_ini']); ?></span>
        </div>
        <div style="display:flex; justify-content:space-between; align-items:center;">
          <span style="font-size:13px; color:#6b7280; font-weight:600;">Produk Aktif</span>
          <span style="font-size:18px; font-weight:900; color:#1f2937;"><?php echo e($stats['total_produk']); ?></span>
        </div>
      </div>
    </div>
    ...
    <div
      ...
      <div style="display:flex; flex-direction:column; gap:10px;">
        ...
        <a href="<?php echo e(route('admin.pesanan.index', ['status' => 'menunggu'])); ?>"
          style="display:flex; align-items:center; gap:12px; padding:12px; background:#f9fafb; border-radius:12px; text-decoration:none; font-size:13px; font-weight:700; color:#1f2937; transition:all 0.15s;"
          onmouseover="this.style.background='#fff7ed'; this.style.color='#FF5C00'"
          onmouseout="this.style.background='#f9fafb'; this.style.color='#1f2937'">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>