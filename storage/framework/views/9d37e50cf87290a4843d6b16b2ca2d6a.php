...
<?php $__env->startSection('subtitle', 'Kelola semua akun pengguna'); ?>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
  <div class="bg-white rounded-2xl border border-orange-50 shadow-sm p-5">
    ...
    <p class="text-3xl font-black text-on-surface"><?php echo e($users->total()); ?></p>
  </div>
  <div class="bg-white rounded-2xl border border-orange-50 shadow-sm p-5">
    <p class="text-xs text-gray-400 font-bold uppercase mb-1">Customer</p>
    <p class="text-3xl font-black text-on-surface"><?php echo e(\App\Models\User::where('role','customer')->count()); ?></p>
  </div>
  <div class="bg-white rounded-2xl border border-orange-50 shadow-sm p-5">
    <p class="text-xs text-gray-400 font-bold uppercase mb-1">Admin</p>
    <p class="text-3xl font-black text-on-surface"><?php echo e(\App\Models\User::where('role','admin')->count()); ?></p>
  </div>
  <div class="bg-white rounded-2xl border border-orange-50 shadow-sm p-5">
    <p class="text-xs text-gray-400 font-bold uppercase mb-1">Baru Bulan Ini</p>
    <p class="text-3xl font-black text-on-surface"><?php echo e(\App\Models\User::whereMonth('created_at', now()->month)->count()); ?></p>
  </div>
</div>
        ...
        <tr class="hover:bg-orange-50/30 transition-colors">
          <td class="px-6 py-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-bold text-sm text-on-surface"><?php echo e($user->name); ?></p>
          ...
          <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($user->telepon ?? '-'); ?></td>
          <td class="px-6 py-4">
            <span class="font-bold text-sm"><?php echo e($user->pesanans->count()); ?> pesanan</span>
          </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\user\index.blade.php ENDPATH**/ ?>