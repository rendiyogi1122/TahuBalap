...
<?php $__env->startSection('subtitle', 'Tambahkan produk tahu baru ke katalog Anda'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
  <div class="bg-white rounded-xl shadow-sm border border-orange-50 overflow-hidden">
    <div class="p-8">
      <form action="<?php echo e(route('admin.produk.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="number" id="harga" name="harga" value="<?php echo e(old('harga')); ?>" step="1000" min="0"
...
unset($__errorArgs, $__bag); ?>
          ...
          <div>
            ...
            <input type="number" id="stok" name="stok" value="<?php echo e(old('stok')); ?>" min="0"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input type="text" id="satuan" name="satuan" value="<?php echo e(old('satuan', 'Pcs')); ?>"
...
unset($__errorArgs, $__bag); ?> rounded-lg focus:ring-2 focus:ring-[#FF5C00] focus:outline-none transition"
            placeholder="Jelaskan keunggulan dan karakteristik produk..."><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center">
          <input type="checkbox" id="aktif" name="aktif" value="1" <?php echo e(old('aktif') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\admin\produk\create.blade.php ENDPATH**/ ?>