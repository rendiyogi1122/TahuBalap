...
<?php $__env->startSection('title', 'Resep Tahu'); ?>
  ...
  <div style="display:grid; grid-template-columns:220px 1fr; gap:28px; align-items:start;">
    ...
    <div>
      ...
      <div style="background:white; border-radius:16px; border:1px solid #f3f4f6; padding:20px; margin-bottom:20px;">
        ...
        <div style="display:flex; flex-direction:column; gap:4px;">
          <a href="<?php echo e(route('resep.index')); ?>" style="padding:10px 14px; background:#FF5C00; color:white; border-radius:10px; font-size:13px; font-weight:700; text-decoration:none; display:block;">
            All Recipes
          </a>
          ...
          <a href="<?php echo e(route('resep.index', ['kategori' => $kat])); ?>" style="padding:10px 14px; color:#4b5563; border-radius:10px; font-size:13px; font-weight:600; text-decoration:none; display:block; transition:background 0.15s;"
      ...
      <div style="background:linear-gradient(135deg, #1f4e3d, #2c6e4f); border-radius:16px; padding:20px; color:white;">
        ...
        <a href="<?php echo e(route('resep.show', 'tahu-gejrot-pedas')); ?>" style="font-size:12px; font-weight:800; color:#FEB700; text-decoration:underline;">
          Get Cooking →
        </a>
      </div>
    </div>
    ...
    <div id="resep-grid">
      <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:20px; margin-bottom:20px;">
        <?php $__currentLoopData = $reseps->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div style="background:white; border-radius:20px; border:1px solid #f3f4f6; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.05); transition:all 0.2s; cursor:pointer;"
          ...
          <div style="position:relative; height:170px; background:linear-gradient(135deg, #fff7ed, #ffe4cc); display:flex; align-items:center; justify-content:center; overflow:hidden;">
            ...
            <?php else: ?>
              <span style="font-size:72px;"><?php echo e($resep->emoji); ?></span>
            <?php endif; ?>
            <div style="position:absolute; top:10px; left:10px; background:<?php echo e($resep->badge_color); ?>; color:white; font-size:10px; font-weight:800; padding:4px 10px; border-radius:6px; letter-spacing:1px;">
            ...
            <div style="position:absolute; bottom:10px; right:10px; background:rgba(0,0,0,0.7); color:#FEB700; font-size:12px; font-weight:800; padding:4px 10px; border-radius:8px;">
              Rp<?php echo e(number_format($resep->harga, 0, ',', '.')); ?>
          ...
          <div style="padding:16px;">
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:8px;">
              <span style="display:flex; align-items:center; gap:4px; font-size:11px; color:#9ca3af; font-weight:600;">
                <span class="material-symbols-outlined" style="font-size:13px;">schedule</span> <?php echo e($resep['waktu']); ?>

              </span>
              <span style="display:flex; align-items:center; gap:4px; font-size:11px; color:#9ca3af; font-weight:600;">
                <span class="material-symbols-outlined" style="font-size:13px;">signal_cellular_alt</span> <?php echo e($resep['level']); ?>

              </span>
            </div>
            <h3 style="font-size:16px; font-weight:800; color:#1f2937; margin:0 0 6px; line-height:1.3;"><?php echo e($resep['nama']); ?></h3>
            <p style="font-size:12px; color:#6b7280; margin:0 0 14px; line-height:1.5;"><?php echo e(Str::limit($resep['deskripsi'], 80)); ?></p>
            <div style="display:flex; align-items:center; gap:8px;">
              <a href="<?php echo e(route('resep.show', $resep['slug'])); ?>"
              ...
              <form action="<?php echo e(route('keranjang.tambah')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php $produk = \App\Models\Produk::where('aktif', true)->first(); ?>
                <?php if($produk): ?>
      ...
      <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:20px;">
        <?php $__currentLoopData = $reseps->skip(3)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div style="background:white; border-radius:20px; border:1px solid #f3f4f6; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.05); transition:all 0.2s;"
          ...
          <div style="position:relative; height:170px; background:linear-gradient(135deg, #fff7ed, #ffe4cc); display:flex; align-items:center; justify-content:center;">
            <span style="font-size:72px;"><?php echo e($resep['emoji']); ?></span>
            <div style="position:absolute; top:10px; left:10px; background:<?php echo e($resep['badge_color']); ?>; color:white; font-size:10px; font-weight:800; padding:4px 10px; border-radius:6px;">
              <?php echo e($resep['badge']); ?>
          ...
          <div style="padding:16px;">
            ...
            <h3 style="font-size:16px; font-weight:800; color:#1f2937; margin:0 0 6px;"><?php echo e($resep['nama']); ?></h3>
            <p style="font-size:12px; color:#6b7280; margin:0 0 14px; line-height:1.5;"><?php echo e(Str::limit($resep['deskripsi'], 80)); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\resep\index.blade.php ENDPATH**/ ?>