          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="text" name="telepon" value="<?php echo e(old('telepon', auth()->user()->telepon)); ?>"
                  class="w-full pl-11 pr-4 border border-outline-variant rounded-xl py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low transition-all <?php $__errorArgs = ['telepon'];
            ...
            <div>
              ...
              <div class="relative">
                ...
                <textarea name="alamat_pengiriman" rows="3"
                  class="w-full pl-11 pr-4 border border-outline-variant rounded-xl py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low resize-none transition-all <?php $__errorArgs = ['alamat_pengiriman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                  placeholder="Jl. Raya No. 123, RT/RW, Kelurahan, Kecamatan, Kota"><?php echo e(old('alamat_pengiriman', auth()->user()->alamat)); ?></textarea>
              </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <textarea name="catatan" rows="2"
                  ...
                  placeholder="Contoh: Jangan terlalu pedas, taruh di depan pagar..."><?php echo e(old('catatan')); ?></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl shadow-orange-900/5 border border-surface-variant p-8 sticky top-24">
          ...
          <div class="space-y-3 mb-6 max-h-60 overflow-y-auto pr-1">
            ...
            <div class="flex items-center gap-3">
              <div class="w-12 h-12 rounded-xl flex-shrink-0 bg-primary-fixed flex items-center justify-center overflow-hidden">
                <?php if($item['gambar']): ?>
                  <img src="<?php echo e(Storage::url($item['gambar'])); ?>" class="w-full h-full object-cover">
                <?php else: ?>
                  <span class="text-xl">🧀</span>
                <?php endif; ?>
              </div>
              <div class="flex-grow min-w-0">
                <p class="text-sm font-semibold text-on-surface truncate"><?php echo e($item['nama']); ?></p>
                <p class="text-xs text-on-surface-variant"><?php echo e($item['jumlah']); ?> x Rp<?php echo e(number_format($item['harga'], 0, ',', '.')); ?></p>
              </div>
              <p class="text-sm font-black text-on-surface flex-shrink-0">Rp<?php echo e(number_format($item['harga'] * $item['jumlah'], 0, ',', '.')); ?></p>
            </div>
          ...
          <div class="border-t border-outline-variant pt-4 space-y-2 mb-6">
            ...
            <div class="flex justify-between font-black text-on-surface">
              ...
              <span class="text-[#FF5C00] text-xl">Rp<?php echo e(number_format($total + 5000, 0, ',', '.')); ?></span>
            </div>
          </div>
          ...
          <a href="<?php echo e(route('keranjang.index')); ?>" class="block text-center text-sm text-on-surface-variant font-bold mt-4 hover:underline">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\pesanan\checkout.blade.php ENDPATH**/ ?>