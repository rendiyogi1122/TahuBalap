            ...
            <div>
              ...
              <div class="relative">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                  class="w-full pl-11 pr-4 py-3 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low transition-all <?php $__errorArgs = ['name'];
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input id="password" type="password" name="password" required
                  class="w-full pl-11 pr-12 py-3 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#FF5C00] focus:border-[#FF5C00] bg-surface-container-low transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-sm text-on-surface-variant">
          Sudah punya akun?
          <a href="<?php echo e(route('login')); ?>" class="text-[#FF5C00] font-black hover:underline ml-1">Masuk di sini</a>
        </p>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\toko-tahu\resources\views\auth\register.blade.php ENDPATH**/ ?>